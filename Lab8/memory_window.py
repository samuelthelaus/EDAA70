...
if __name__ == '__main__':
    ...
    front = ['friends.jpg', 'mrs_rabbit.jpg', 'can.jpg', 'mother_ladybird.jpg', 
             'mrs_tittlemouse.jpg', 'flopsy_mopsy_cottontail.jpg', 
             'mr_mcgregor.jpg', 'radishes.jpg']
    front = [f'images/{f}' for f in front]
    board = MemoryBoard(4, front, back)
    game = MemoryGame(board)

    # Create memory window
    app = QtWidgets.QApplication(sys.argv)
    ex = MemoryWindow(game)
